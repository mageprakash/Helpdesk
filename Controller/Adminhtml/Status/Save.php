...
namespace MagePrakash\Helpdesk\Controller\Adminhtml\Status;
...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create(\MagePrakash\Helpdesk\Model\Status::class)->load($id);
            if (!$model->getId() && $id) {
            ...
            $this->dataPersistor->set('mageprakash_helpdesk_status', $data);
