...
class Edit extends \MagePrakash\Helpdesk\Controller\Adminhtml\Ticket
{
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create(\MagePrakash\Helpdesk\Model\Ticket::class);
        ...
        $this->_coreRegistry->register('mageprakash_helpdesk_ticket', $model);
